...
data class PluginsInfo(
    ...
    @SerialName(value = "Volume") val volume: List<String>? = null,
    // Names of available network-drivers, and network-driver plugins.
    @SerialName(value = "Network") val network: List<String>? = null,
    // Names of available authorization plugins.
    @SerialName(value = "Authorization") val authorization: List<String>? = null,
    // Names of available logging-drivers, and logging-driver plugins.
    @SerialName(value = "Log") val log: List<String>? = null,
)
