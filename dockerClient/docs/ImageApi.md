...
classic (deprecated) builder in the Docker daemon (default) - &#x60;2&#x60;
...
with the host&#39;s native OS and Architecture. If the given image does exists in the local image cache, but its OS or
